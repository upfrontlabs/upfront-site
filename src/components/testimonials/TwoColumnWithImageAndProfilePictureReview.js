...
export default ({
  ...
  description = "Check out the success stories of some of our over satisfied clients worldwide. We have a large number of happy clients across the globe: \n Have a look at some of the tales of success from our customers.",
  testimonials = null,
  textOnLeft = false
}) => {
  /*
  ...
  const defaultTestimonials = [
    {
      imageSrc:
        "https://images.unsplash.com/photo-1551263640-1c007852f616?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
      profileImageSrc:
      ...
      quote:
        "Recommended! The skilled team at Upfront Labs has allowed us to scale during specific projects, and we've been working with them for over a year. Our full-time team was able to concentrate on core platform functionality as a result. ",
      customerName: "Adam M.",
      customerTitle: "CEO, Echo Cabs."
    },
    {
      imageSrc:
        "https://images.unsplash.com/photo-1597740985671-2a8a3b80502e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2787&q=80",
      profileImageSrc:
        "https://images.unsplash.com/photo-1635003913011-95971abba560?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=756&q=80",
      quote:
        "We highly recommend Upfront Labs for any business website development needs. Their coding and development services for our website have exceeded our expectations, and we are extremely satisfied.",
      customerName: "Krishna murthy",
      customerTitle: "Founder, TechGrid Inc"
    }
  ];
