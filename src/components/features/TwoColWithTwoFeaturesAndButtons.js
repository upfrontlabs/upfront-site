...
export default ({
  ...
  description = "At Upfront Labs, we provide access to experienced developers for custom software solutions for your enterprise, startup, or agency. As a dedicated software team, we understand the importance of meeting your business goals and strive to add value to your team.",
  ...
  const defaultFeatures = [
    {
      ...
      description: "We have the best developers across the globe just to work with you."
    },
    {
      Icon: MoneyIcon,
      title: "Affordable",
